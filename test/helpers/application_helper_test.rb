...
class ApplicationHelperTest < ActionView::TestCase
  test "log_phase marks archci-build's slice transitions and nothing else" do
    assert_equal "online", log_phase("==> Installing the pacman dependencies in the archci-online slice (with network)")
    ...
    assert_nil log_phase("==> Installing missing dependencies...")   # makepkg's line, not ours
